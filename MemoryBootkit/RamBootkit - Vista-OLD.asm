...
;Main program - OLD Version, unstable
...
; Windows Vista Signature (SP1)
;bootmgr_firstbyte db 06Fh
;bootmgr_signature dd 01802787dh          ; last four bytes of bootmgr
; Windows Vista Signature
bootmgr_firstbyte db 0F6h
pad db 00h
bootmgr_signature dd 04ADE979Bh          ; last four bytes of bootmgr
...
MemLicense_Search2:
    ...
    jne MemLicense_Search
    mov byte [edi-1], 0ebh      ; JMP Rel16 opcode
